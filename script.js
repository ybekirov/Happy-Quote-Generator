...
var makeButton   = document.getElementById('make-quote');
...
function makeQuote() {
  Swal.fire({
    title: 'Please Make a Quote!',
    input: 'text',
    inputAttributes: {
      autocapitalize: 'off'
    },
    showCancelButton: true,
    confirmButtonText: 'Make Quote',
...
quoteButton.onclick = replaceQuote;
makeButton.onclick  = makeQuote;